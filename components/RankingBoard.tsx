  ...
  return (
    <div className="absolute inset-0 
      ...
      <div className="relative mb-[3svh] text-center flex-shrink-0 z-10">
        ...
        <p className="text-[1.3svh] mt-[0.5svh] text-white pixel-font uppercase opacity-100 tracking-tighter whitespace-nowrap">매주 수요일마다 랭킹이 초기화됩니다</p>
      </div>
      ...
      <div className="relative bg-white/15 rounded-[3svh] p-[5%] flex-grow overflow-hidden flex flex-col border border-white/50 shadow-inner z-10">
        {loading ? (
          <div className="flex-1 flex items-center justify-center pixel-font text-[2svh] font-bold">로딩 중...</div>
        ) : (
