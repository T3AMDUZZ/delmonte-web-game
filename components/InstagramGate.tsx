  ...
  return (
    <div className="absolute inset-0 
      ...
      <div className="relative w-full flex flex-col items-center space-y-[2svh] mb-[5%] flex-shrink-0 z-10 mt-[8svh]">
        ...
        <div className="text-white pixel-font text-[1.4svh] leading-none bg-black/30 py-[2.5%] px-[8%] rounded-full inline-flex items-center justify-center backdrop-blur-sm whitespace-nowrap" style={{ wordSpacing: '-0.2em' }}>
